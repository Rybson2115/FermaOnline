...
namespace FermaOnline.Models
{
    public class ExperimentDTO
    {
        ...
        public List<SurveyDTO> SurveysList { get; set; }
        ...
        public ExperimentDTO(string name,string description, string shortDescription, string species,int cageNumber) : base()
        {
            Name = name;
        ...
        public ExperimentDTO(string name, string description, string shortDescription, string species,int cageNumber, List<Image> images) : this( name,  description, shortDescription,  species, cageNumber)
        {
            Images = images;
        }
