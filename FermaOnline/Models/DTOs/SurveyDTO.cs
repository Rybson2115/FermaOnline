...
namespace FermaOnline.Models
{
    public class SurveyDTO
    {
        ...
        public SurveyDTO(SurveyDTO newSurvey) : this()
        {
        ...
        public SurveyDTO(SurveyDTO newSurvey, SurveyDTO lastSurvey,List<float> cageFirstIndividualBodyWeight,int cageCount) : this(newSurvey)
        {
